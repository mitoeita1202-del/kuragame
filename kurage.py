...
image1 = pygame.transform.scale(pygame.image.load("スイカ画像/game over 筆記体.png"), (WIDTH, HEIGHT))#画像ロード
...
img_blue   = pygame.image.load("スイカ画像/クラゲ：卵.png")#os
img_red    = pygame.image.load("スイカ画像/クラゲ：プラヌラ.png")#CPU
img_green  = pygame.image.load("スイカ画像/クラゲ：ポリプ.png")#メモリ
img_yellow = pygame.image.load("スイカ画像/ストロビラ.png")#マザーボード
img_pink = pygame.image.load("スイカ画像/スクリーンショット_21-8-2026_12443_www.bing.com-Photoroom.png")
img_orange = pygame.image.load("スイカ画像/クラゲ.png")
...
while True:
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if event.key == pygame.K_r:  # Rキーでリトライ
                reset_game()
